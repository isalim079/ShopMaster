...
import { useGetSalesReportQuery } from '@/src/features/reports/api/reportsApi';
import type { SalesReportRow } from '@/src/features/reports/types';
import {
  AppText,
  Button,
  Card,
    ...
    <View className="flex-1 bg-background dark:bg-background-dark">
      ...
      <FlashList
        ...
        ListEmptyComponent={
          <EmptyState
            title="No sales"
            description="No sales found for this date range."
          />
        }
  ...
  return (
    <Card className="mb-3 gap-1">
      ...
      <AppText variant="caption">
        {row.customerName ?? 'Walk-in'} · {formatDate(row.saleDate)}
      </AppText>
      <AppText variant="caption">
